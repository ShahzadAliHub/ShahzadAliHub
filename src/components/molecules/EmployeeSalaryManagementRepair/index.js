  ...
  return (
    <div className="h-screen w-full flex flex-col md:flex-row items-center justify-center">
      <div className="min-h-screen flex justify-center items-center">
        <img src={Repair} alt="Pinterest clone project" className="w-70 h-70" />
      </div>
      ...
      <div className="flex flex-col items-center translate-y-[-120%] sm:translate-y-[-0%]">
        <h2 className="text-2xl text-center mb-4">
          ...
          visit github for the Pinterest project
        </h2>
        <Link to="https://github.com/ShahzadAliHub/pinterest-blog">
          <PrimaryBtn className="translate-y-[70%] sm:translate-y-[-0%] p-10">
            <span>Go To Github Pinterest clone project</span>
            <span>
              <FaGithub></FaGithub>
            </span>
          </PrimaryBtn>
