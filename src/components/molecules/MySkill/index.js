...
import {
  ...
  FaSearch,
  FaBullhorn,
} from "react-icons/fa"; // FaSearch for SEO and FaBullhorn for Digital Marketing
import {
  SiJavascript,
  SiTailwindcss,
  SiExpress,
...
const MySkill = () => {
  ...
  const tools = [
    ...
    { title: "SEO", icon: <FaSearch className="text-blue-600" /> }, // Updated to FaSearch for SEO
    {
      title: "Digital Marketing",
      icon: <FaBullhorn className="text-red-500" />, // Updated to FaBullhorn for Digital Marketing
    },
  ];
